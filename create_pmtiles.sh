...
# create_pmtiles.sh
# ---------------------------------------------------------------------------
# Converts the GeoJSON into a PMTiles file for use with MapLibre GL JS.
#
...
GEOJSON_INPUT="neighborhoods_with_hospital_counts.geojson"
OUTPUT="hospital_with_counts.pmtiles"
...
if [ ! -f "$GEOJSON_INPUT" ]; then
    ...
    echo "   Expected: part2-languages/2.3-sql-analysis/output/hospital_density.geojson"
    exit 1
fi
